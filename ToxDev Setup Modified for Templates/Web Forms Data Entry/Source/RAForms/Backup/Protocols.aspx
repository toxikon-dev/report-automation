...
<body>
    ...
    <asp:SqlDataSource 
        ...
        UpdateCommand="UPDATE tblProtocols SET txtProtocolName = @txtProtocolName, txtReportQuery = @txtReportQuery, txtProtocolType = @ProtocolType, booQAReview = @booQAReview, txtWebForm = @txtWebForm WHERE txtProtocolName = @txtProtocolName" 
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="ProtocolType" />
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="intProtocolID" 
        ...
        <EmptyDataTemplate>
            ...
            <tr><td style="height: 80px;">Please select a protocol to edit -or- click the New button to enter a new user.
                </td></tr>
            </table>
        </EmptyDataTemplate>
        <FooterTemplate>
