...
Partial Public Class Kligman
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If ds.Tables(0).Rows.Count = 0 Then
            Response.Redirect("error.aspx?E=User_Not_Found&S=Kligman.aspx&U=" & strUsername & "&D=" & strDatabase)
        ElseIf ds.Tables(0).Rows(0).Item(0).ToString = "DPS" Or ds.Tables(0).Rows(0).Item(0).ToString = "DE" Then
            'these are OK
        Else
            Response.Redirect("error.aspx?E=User_Not_Authorized&S=Kligman.aspx&U=" & strUsername & "&D=" & strDatabase)
        End If
        ds.Dispose()
        da.Dispose()
    ...
    Protected Sub SubmitButton_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If ds.Tables(0).Rows(0).Item(0).ToString = "Waiting review" _
            ...
            myGUID = mySharePoint.AddSPTask("SD Review, 09-ISO-Kligman-N, " & StudyDropDownList.SelectedValue & ", " & mySponsor, "", "", myAssignTo, "Tasks")
            If Left(myGUID, 5) = "ERROR" Then
