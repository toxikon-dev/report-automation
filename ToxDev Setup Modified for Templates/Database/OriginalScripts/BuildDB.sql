USE [master]
GO
/****** Object:  Database [Toxikon_ra]    Script Date: 09/24/2009 10:24:48 ******/
...
SELECT     p.txtSampleNumber, p.txtTestType, p.intProjectNumber, p.txtProjectNumber, p.txtStudyNumber, p.txtProtocolNumber, p.intStudyDirector, 
                      ...
                      p.dteExtractionStartDate, p.dteExtractionEndDate, p.booAmendmentPending, p.booReformatPending, p.memAmendments, p.txtActiveTaskGUID, 
